...
from model.display import display_loss
...
class Model:
    def __init__(self,
        ...
        self.hard_list = list()
        self.full_list = list()
        self.loss_num_list = list()
        self.mdist_list = list()
    ...
    def fit(self):
        if self.restore_iter != 0: # restore_iter is 0 initially
        ...
        train_label_set.sort() # ['person01', 'person02', ...]
        ...
        for seq, view, seq_type, label, batch_frame in train_loader:
            ...
            if self.restore_iter % 100 == 0:
                ...
                self.iter_list.append(self.restore_iter)
                self.hard_list.append(np.mean(self.hard_loss_metric))
                self.full_list.append(np.mean(self.full_loss_metric))
                self.loss_num_list.append(np.mean(self.full_loss_num))
                self.mdist_list.append(self.mean_dist)
        ...
        display_loss(self.iter_list, self.hard_list, self.full_list, self.loss_num_list, self.mdist_list)
